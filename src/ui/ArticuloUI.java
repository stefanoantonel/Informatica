...
//					arbol.MostrarArbol();
					...
					arbol.MostrarArbol(arbol.getNodoByDescripcion(articuloSelecc.getDescripcion()),cant,"'"+a+"'");
//					ar.MostrarArbol();
				}
				else{
					Arbol arbol=new Arbol();
...
//					arbol.MostrarArbol();
					System.out.println("a:"+a);
					arbol.MostrarArbol(arbol.getNodoByDescripcion(articuloSelecc.getDescripcion()),cant,hoy);
				}
...
//					arbol.MostrarArbol();
					System.out.println("a:"+a);
					arbol.MostrarArbol(arbol.getNodoByDescripcion(articuloSelecc.getDescripcion()),1,"'"+a+"'");
//					ar.MostrarArbol();
...
//					arbol.MostrarArbol();
					//System.out.println("a:"+a);
					arbol.MostrarArbol(arbol.getNodoByDescripcion(articuloSelecc.getDescripcion()),1,hoy);
//					ar.MostrarArbol();
				}
...
//		getContentPane().add(button);
	...
	public void InicializarCampos() {
		...
		codigoArticulo.setText(articuloSelecc.getArt().getValor().toString());
